...
Each step of the pipeline as depicted in the pipeline schematic is broken down and explained below, with the inputs and outputs highlighted.
...
*Output files*:
* `results/imctools/full_stack/*.tiff`  
* `results/imctools/ilastik_stack/*.tiff`  
