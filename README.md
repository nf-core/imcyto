...
**NOTE: I think the schematic should also be added here as it nicely illustrates what this pipeline is for**
...
**NOTE: Maybe we should ask before adding everyones email here?**
