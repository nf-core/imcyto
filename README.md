...
[![AWS CI](https://img.shields.io/badge/CI%20tests-full%20size-FF9900?labelColor=000000&logo=Amazon%20AWS)](https://nf-co.re/imcyto/results)
...
[![Get help on Slack](http://img.shields.io/badge/slack-nf--core%20%23imcyto-4A154B?labelColor=000000&logo=slack)](https://nfcore.slack.com/channels/imcyto)
...
**nf-core/imcyto** is a bioinformatics best-practice analysis pipeline for Image Mass Cytometry analysis pipeline..
...
3. Download the pipeline and test it on a minimal dataset with a single command:
    ...
    ```console
    nextflow run nf-core/imcyto -profile test,<docker/singularity/podman/shifter/charliecloud/conda/institute>
    ```
...
4. Start running your own analysis!
    ...
    ```console
    nextflow run nf-core/imcyto -profile <docker/singularity/podman/shifter/charliecloud/conda/institute> --input samplesheet.csv --genome GRCh37
    ```
...
nf-core/imcyto was originally written by Harshil Patel.
