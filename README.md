...
[![AWS CI](https://img.shields.io/badge/CI%20tests-full%20size-FF9900?labelColor=000000&logo=Amazon%20AWS)](https://nf-co.re/imcyto/results)[![Cite with Zenodo](http://img.shields.io/badge/DOI-10.5281/zenodo.XXXXXXX-1073c8?labelColor=000000)](https://doi.org/10.5281/zenodo.XXXXXXX)
...
**nf-core/imcyto** is a bioinformatics pipeline that ...
...
For more details, please refer to the [usage documentation](https://nf-co.re/imcyto/usage) and the [parameter documentation](https://nf-co.re/imcyto/parameters).

## Pipeline output

To see the the results of a test run with a full size dataset refer to the [results](https://nf-co.re/imcyto/results) tab on the nf-core website pipeline page.
